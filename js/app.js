(() => {
    ...
    const questions = [ {
        ...
        question: "То вам, панове, правдиво, під сумлінням, кажу і людьми те освідчу.",
        answers: [ "Означено - особове", "Неозначено - особове", "Узагальнено - особове", "Називне", "Безособове"],
        correct: 1
    }, {
